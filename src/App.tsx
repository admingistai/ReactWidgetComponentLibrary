...
import {
  AnimatedCard,
  AnimatedCardList,
} from "@/components/primitives/AnimatedCard";
import { ReorderableList } from "@/components/primitives/DraggableItem";
import {
  Card,
  CardContent,
  CardDescription,
...
function App() {
  ...
  const demoWidget = useWidget({
    id: "demo-widget",
    initialState: WIDGET_STATES.FLOATING,
    initialPosition: WIDGET_POSITIONS.TOP_RIGHT,
    persist: true,
  });
          ...
          <TabsContent value="widget" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Pure presentational components with no state - the foundation of our widget system
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* Icons */}
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-4 items-center p-4 bg-muted/50 rounded-lg">
                    <div className="flex flex-col items-center gap-2">
                      <SparkleIcon />
                      <span className="text-xs text-muted-foreground">SparkleIcon</span>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                      <MicIcon />
                      <span className="text-xs text-muted-foreground">MicIcon</span>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                      <PlusIcon />
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <PlusButtonIcon />
                      <span className="text-xs text-muted-foreground">PlusButtonIcon</span>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                      <GradientIcon />
                      <span className="text-xs text-muted-foreground">GradientIcon</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 p-4 bg-muted/50 rounded-lg">
                    <div className="flex items-center gap-4">
                      <Text variant="ask">Ask anything...</Text>
                      <span className="text-xs text-muted-foreground">variant="ask"</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <Text variant="suggestion">Top Stories</Text>
                      <span className="text-xs text-muted-foreground">variant="suggestion"</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <Text variant="powered">Powered by</Text>
                      <span className="text-xs text-muted-foreground">variant="powered"</span>
                    </div>
                  </div>
                </div>
                ...
                {/* Logos */}
                <div className="space-y-3">
                  <h4 className="text-sm font-medium text-muted-foreground">Logos</h4>
                  <div className="flex flex-wrap gap-6 items-center p-4 bg-muted/50 rounded-lg">
                    <div className="flex flex-col items-center gap-2">
                      <NYTimesLogo />
                      <span className="text-xs text-muted-foreground">NYTimesLogo</span>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                      <PoweredByLogo />
                      <span className="text-xs text-muted-foreground">PoweredByLogo</span>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-4">
                        <GlassContainer variant="searchBar">
                          <span className="text-sm px-4">SearchBar Container</span>
                        </GlassContainer>
                        <span className="text-xs text-muted-foreground">variant="searchBar"</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <WidgetIconButton>
                      ...
                      <span className="text-xs text-muted-foreground">IconButton</span>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Components composed of multiple atoms - still pure presentational but more complex
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="p-4 bg-muted/50 rounded-lg">
                        <CompactButton onClick={() => console.log('Compact clicked')} />
                      </div>
                    </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Page-level components that combine organisms with state management
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  <h4 className="text-sm font-medium">MainFlow (Complete Widget)</h4>
                  <div className="p-6 bg-muted/50 rounded-lg flex justify-center">
                    <MainFlow 
                      initialExpanded={false}
                      onSuggestionSelect={(suggestion) => console.log('Template suggestion:', suggestion)}
                    />
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Click to expand and test the complete widget functionality including click-outside behavior
                  </p>
                </div>
              </CardContent>
            </Card>
